    ...
    class WebHunt_Filesystem
    {
        ...
        public function ftp_form()
        {
            if (isset($this->parent->ftp_form) && !empty($this->parent->ftp_form)) {
                ...
                echo __('Unable to modify required files. Please ensure that', 'kyma');
                echo __('has the proper read/write permissions or enter your FTP information below.', 'kyma');
        ...
        public function execute($action, $file = '', $params = '')
        {
            ...
            $base = 'themes.php?page=kyma-welcome';
            

            $url = wp_nonce_url($base, 'kyma-welcome');

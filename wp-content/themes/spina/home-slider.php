...
if ($kyma_theme_options['home_slider_enabled'] == 1){ ?>
				...
				<?php } ?>	
					<span class="owl_text_d">
						<a id="slide-description-<?php echo $i; ?>" href="<?php echo esc_url(get_post_permalink($slider->ID)); ?>" target="_self" class="btn_a">
							<span><i class="in_left fa fa-link"></i><span><?php _e('Read More', 'spina'); ?></span><i class="in_right fa fa-link"></i></span>
						</a>
					</span>
            </div>
            </div><?php
	...
	<?php } else {
		for($i=1 ; $i<=3 ; $i++){ ?>
			<div class="item">
				<img src="<?php echo child_template_directory; ?>/images/slide1.jpg" alt="Slide Title">
				<div class="owl_slider_con">
					<span class="owl_text_a">
						<span>
							<span><?php _e('Spina Theme IS The Best', 'spina'); ?></span>
						<a href="#"><span><i class="fa fa-angle-right"></i></span></a>
						</span>
					</span>
					<span class="owl_text_c"><span><?php _e('Lorem Ipsum is simply dummy text of the printing and industry...', 'spina'); ?></span></span>
					<span class="owl_text_d">

...
<div id="main_wrapper">
    <header id="site_header">
        <div class="topbar <?php echo esc_attr($kyma_theme_options['topbarcolor']); ?> topbar1">
            ...
            <div class="content clearfix">
                ...
                <div class="top_details clearfix f_left"><?php
                    if ($kyma_theme_options['contact_phone']) {
                        ...
                        <span><i class="fa fa-phone"></i><span
                            class="title"><?php _e('Call Us :', 'spina') ?></span><a href="tel:<?php echo esc_attr($kyma_theme_options['contact_phone']); ?>"><?php echo esc_attr($kyma_theme_options['contact_phone']); ?></a>
                        </span><?php
                    }
                    if ($kyma_theme_options['contact_email']) {
                        ?>
                        <span><i class="fa fa-envelope-o"></i><span
                                class="title"><?php _e('Email :', 'spina') ?></span>
                ...
                <?php } if ($kyma_theme_options['social_media_header']) { ?>
                    ...
                    <a href="<?php echo esc_url($kyma_theme_options['social_facebook_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('Facebook', 'spina'); ?></span>
                    ...
                    <a href="<?php echo esc_url($kyma_theme_options['social_twitter_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('Twitter', 'spina'); ?></span>
                        <span class="soc_icon_bg"></span>
                    ...
                    <a href="<?php echo esc_url($kyma_theme_options['social_google_plus_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('Google+', 'spina'); ?></span>
                        <span class="soc_icon_bg"></span>
                    ...
                    <a href="skype:<?php echo esc_url($kyma_theme_options['social_skype_link']); ?>">
                        <span class="soc_name"><?php _e('Skype', 'spina'); ?></span>
                        <span class="soc_icon_bg"></span>
                    ...
                    <a href="<?php echo esc_url($kyma_theme_options['social_vimeo_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('Vimeo', 'spina'); ?></span>
                        <span class="soc_icon_bg"></span>
                    ...
                    <a href="<?php echo esc_url($kyma_theme_options['social_youtube_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('YouTube', 'spina'
                            ); ?></span>
                        <span class="soc_icon_bg"></span>
                        <i class="fa fa-youtube"></i>
                        </a><?php
                    }
					if ($spina_theme_options['social_linkedin_link'] != '') { ?>
                    <a href="<?php echo esc_url($spina_theme_options['social_linkedin_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('Linkedin', 'spina'); ?></span>
                        <span class="soc_icon_bg"></span>
                        <i class="fa fa-linkedin"></i>
                        </a><?php
                    }
					if ($spina_theme_options['social_pinterest_link'] != '') { ?>
                    <a href="<?php echo esc_url($spina_theme_options['social_pinterest_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('Pinterest', 'spina'); ?></span>
                        <span class="soc_icon_bg"></span>

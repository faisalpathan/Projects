        ...
        <div class="row_spacer clearfix">
            ...
            <div class="content">
                <div class="main_title centered upper">
                    <h2><span class="line"><i class="fa fa-folder-open-o"></i></span><?php _e('Our Portfolio', 'spina'); ?></h2>
                </div>
            </div>
							...
							<div class="porto_block">
								<div class="porto_type">
									<a data-rel="magnific-popup" href="<?php echo get_template_directory_uri(); ?>/images/item4.jpg">
										<img src="<?php echo child_template_directory; ?>/images/item4.jpg" alt="Portfolio Name">
									</a>
									<div class="porto_nav">
										<a href="#" class="expand_img"><?php _e('View Larger', 'spina'); ?></a>
										<a href="#" class="detail_link"><?php _e('View Details', 'spina'); ?></a>
									</div>
								</div>
								<div class="porto_desc">
									<h6 class="name"><?php _e('Green Project', 'spina'); ?></h6>
									<div class="porto_meta clearfix">
									<span class="porto_date"><span class="number"><?php _e('20141213', 'spina'); ?></span><?php _e('December 13, 2014', 'spina'); ?></span>
									</div>
								</div>
							</div>
                        </div><!-- Item -->

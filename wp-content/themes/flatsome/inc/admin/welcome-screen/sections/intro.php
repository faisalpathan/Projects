...
<div class="col two-col" style="margin-bottom: 1.618em; overflow: hidden;">
	<div class="col-1">
		<h1 style="margin-right: 0;"><?php echo '<strong>Flatsome</strong> <sup style="font-weight: bold; border-radius:999px; font-size: 50%; padding: 5px 10px; color: #666; background: #fff;">' . esc_attr( $flatsome['Version'] ) . '</sup>'; ?></h1>

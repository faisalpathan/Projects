...
class ZnContactForm extends ZnElements {
	...
	function element() {
		...
		<div
			class="zn_contact_form_container contactForm cf-elm <?php echo implode( ' ', $elm_classes ); ?>" <?php echo $attributes; ?>>
			...
			if ( $fields ) {
				...
				echo '<span class="zn_submit_container"><button class="zn_contact_submit btn ' . $this->opt( 'button_style', 'btn-fullcolor' ) . ' ' . $this->opt( 'button_corners', 'btn--rounded' ) . '" type="submit">' . $submit_label . '</button></span>';

...
<?php if (have_comments()) : ?>
    ...
    <h3 id="comments" class="kl-comments-title"><?php comments_number( __( 'No Comments', 'zn_framework'), __( '1 Comment', 'zn_framework' ), __( '% Comments', 'zn_framework' ) ); ?> to &#8220;<?php the_title(); ?>&#8221;</h3>

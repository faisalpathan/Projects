	...
	<?php } ?>
		...
		<?php
			...
			if( $load_more === 'yes' ){
				...
				echo '<a class="znprt_load_more_button kl-ptfsortable-loadmore btn btn-lined lined-custom '.$disabled_class.'" data-page="1" data-ppp="'.$portfolio_per_page_show.'" data-categories="'.implode( ',',$category ).'" href="#">'.__( 'Load more', 'zn_framework' ).'</a>';
			}

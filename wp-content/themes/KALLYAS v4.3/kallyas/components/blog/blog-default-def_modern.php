...
<div class=" kl-blog-item-container <?php echo $featPostClass;?> <?php echo implode ( ' ' , get_post_class('blog-post' ) ); ?>">
    <?php
...
<div class="kl-blog-item-container kl-blog--normal-post <?php echo implode ( ' ' , get_post_class('blog-post' ) ); ?> ">

...
function my_theme_register_required_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'illdy',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'strings'      => array(
			...
			'installing'                      => __( 'Installing Plugin: %s', 'illdy' ), // %s = plugin name.
			...
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'illdy' ),  // %1$s = plugin name(s).
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'illdy' ),  // %1$s = plugin name(s).
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'illdy' ), // %s = dashboard link.

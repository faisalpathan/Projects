...
$BPS_ISL_options = get_option('bulletproof_security_options_idle_session');
	...
	if ( $current_user->user_level == 10 && $BPS_ISL_options['bps_isl_administrator'] == '1' || $current_user->user_level == 7 && $BPS_ISL_options['bps_isl_editor'] == '1' || $current_user->user_level == 2 && $BPS_ISL_options['bps_isl_author'] == '1' || $current_user->user_level == 1 && $BPS_ISL_options['bps_isl_contributor'] == '1' || $current_user->user_level == 0 && $BPS_ISL_options['bps_isl_subscriber'] == '1' ) {
